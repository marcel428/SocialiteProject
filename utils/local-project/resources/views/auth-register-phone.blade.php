...
<body class="index-background" data-layout="horizontal">
            ...
            <div class="col-md-8">
                <div>
                                    ...
                                    <div class="card-body pt-0 title-color">
                                        ...
                                        <div class="p-2">
                                            <div class="form-group" id="phone_input">
                                                ...
                                                <input type="text" class="form-control" value="{{ old('phone_number') }}" name="phone_number" id="phone_number" placeholder="Enter phone" required>
                    ...
                    <div style='position:relative; top:-28px; left:35%'>
                        <a id="phone_login" href="/auth-register">login with email</a>
                    </div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(dataResult) {
                    ...
                    if (dataResult.status == 'fail') {
                        ...
                        window.localStorage.setItem('key', dataResult.data);
                    }
                }
            });
        ...
        function displayValidationError(dataResult) {
            if (dataResult) {
                if (dataResult.phone_number && dataResult.phone_number.length > 0) {
                    dataResult.phone_number.forEach(item => {
                        $('#error_div').append(`<label class="error">${item}</label>`)
                    })
                }else{
                    $('#error_div').append(`<label class="error">${dataResult}</label>`) 
                }
